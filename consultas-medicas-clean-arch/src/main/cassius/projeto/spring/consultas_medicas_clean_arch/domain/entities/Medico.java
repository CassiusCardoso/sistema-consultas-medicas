...
import cassius.projeto.spring.consultas_medicas_clean_arch.domain.enums.StatusMedico;
import cassius.projeto.spring.consultas_medicas_clean_arch.domain.exceptions.consulta.ConsultaInvalidaException;
import cassius.projeto.spring.consultas_medicas_clean_arch.domain.exceptions.medico.MedicoInvalidoException;
import cassius.projeto.spring.consultas_medicas_clean_arch.domain.exceptions.medico.MedicoStatusIndisponivelException;
import cassius.projeto.spring.consultas_medicas_clean_arch.domain.valueobjects.Crm;
import cassius.projeto.spring.consultas_medicas_clean_arch.domain.valueobjects.Email;
import cassius.projeto.spring.consultas_medicas_clean_arch.domain.enums.Especialidade;
