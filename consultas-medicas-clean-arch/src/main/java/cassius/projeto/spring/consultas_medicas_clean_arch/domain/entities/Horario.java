...
import java.cassius.projeto.spring.consultas_medicas_clean_arch.domain.exceptions.horario.DataHoraInicioOuFimInvalidoException;
import java.cassius.projeto.spring.consultas_medicas_clean_arch.domain.exceptions.horario.HorarioInvalidoException;
import java.cassius.projeto.spring.consultas_medicas_clean_arch.domain.exceptions.horario.StatusHorarioInvalidoException;
