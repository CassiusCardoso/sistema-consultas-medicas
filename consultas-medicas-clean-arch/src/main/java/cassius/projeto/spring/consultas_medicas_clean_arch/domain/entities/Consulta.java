...
import java.cassius.projeto.spring.consultas_medicas_clean_arch.domain.exceptions.consulta.ConsultaHorarioInvalidoException;
import java.cassius.projeto.spring.consultas_medicas_clean_arch.domain.exceptions.consulta.ConsultaInvalidaException;
import java.cassius.projeto.spring.consultas_medicas_clean_arch.domain.exceptions.consulta.ConsultaStatusInvalidoException;
